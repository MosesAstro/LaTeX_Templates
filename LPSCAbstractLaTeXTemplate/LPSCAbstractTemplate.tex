...
\usepackage[margin=1in]{geometry}	% Set all page margins to 1-inch. This is not yet settled. Will need to test it vs setting 
					% these in the style file.
...
%\titlespacing*{\section} {0.40in}{1.5ex plus .5ex minus .2ex}{1.3ex plus .2ex} % This indents the section titles by 0.0in and defines the 
...
\subsection*{Section styles:} % Using subsections.
...
%\listbib{templatebibliography}{lpsc}
